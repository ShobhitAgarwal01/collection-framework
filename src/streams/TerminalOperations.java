...
public class TerminalOperations {
    public static void main(String[] args) {
        ...
        // anyMatch, allMatch, noneMatch, findFirst, findAny are all short circuit operation, as soon as they find any match
        // they stop processing rest of the elements
        ...
        // 7. toArray()
        Object[] integerStream = Stream.of(1, 2, 3, 4, 5).toArray();

        // 8. min/max
        System.out.println("max: " + Stream.of(2,44,566,3,5).max((o1, o2) -> o2 - o1)); // will give same output as min
        System.out.println("min: " + Stream.of(2,44,566,3,5).min(Comparator.naturalOrder()));
